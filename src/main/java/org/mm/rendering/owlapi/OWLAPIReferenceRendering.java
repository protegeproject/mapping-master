...
public class OWLAPIReferenceRendering extends OWLAPIRendering implements ReferenceRendering
{
	...
	public Optional<OWLLiteral> getOWLLiteral()
	{
		return this.literal;
	}
	...
	{
		return this.entity.isPresent() && this.entity.get().isOWLClass();
	}
	...
	{
		return this.entity.isPresent() && this.entity.get().isOWLDatatype();
	}
}
