...
public abstract class ReferenceRendererConfiguration implements MappingMasterParserConstants
{
  ...
  public int getDefaultEmptyLocation() { return this.defaultEmptyLocation; }

  public int getDefaultEmptyRDFID() { return this.defaultEmptyRDFID; }

  public int getDefaultEmptyRDFSLabel() { return this.defaultEmptyRDFSLabel; }

  public int getDefaultIfOWLEntityExists() { return this.defaultIfOWLEntityExists; }

  public int getDefaultIfOWLEntityDoesNotExist() { return this.defaultIfOWLEntityDoesNotExist; }
