      ...
      if (this.owlObjectHandler.isOWLDataProperty(propertyIRI)) {
        ...
        if (restrictionNode.isOWLMinCardinality()) {
          ...
          if (!hasValueRestrictionNode.isLiteral())
            throw new RendererException("expecting literal for data has value restriction " + restrictionNode);

          // TODO Not correct - literal could also come from reference
        ...
        if (restrictionNode.isOWLMinCardinality()) {
          ...
          if (allValuesFromNode.getObjectOWLAllValuesFromNode().hasOWLClassExpression()) {
            Optional<OWLClassExpressionRendering> classExpressionRendering = renderOWLClassExpression(
              allValuesFromNode.getObjectOWLAllValuesFromNode().getOWLClassExpressionNode());
            if (classExpressionRendering.isPresent()) {
              OWLClassExpression classExpression = classExpressionRendering.get().getOWLClassExpression();
            ...
            Optional<OWLClassRendering> classRendering = renderOWLClass(
              allValuesFromNode.getObjectOWLAllValuesFromNode().getOWLClassNode());
          ...
          if (someValuesFromNode.getOWLObjectSomeValuesFromNode().hasOWLClassExpression()) {
            Optional<OWLClassExpressionRendering> classExpressionRendering = renderOWLClassExpression(
              someValuesFromNode.getOWLObjectSomeValuesFromNode().getOWLClassExpressionNode());
            if (classExpressionRendering.isPresent()) {
              OWLClassExpression classExpression = classExpressionRendering.get().getOWLClassExpression();
            ...
            Optional<OWLClassRendering> classRendering = renderOWLClass(
              someValuesFromNode.getOWLObjectSomeValuesFromNode().getOWLClassNode());
            if (classRendering.isPresent()) {
              OWLClassExpression cls = classRendering.get().getOWLClass();
