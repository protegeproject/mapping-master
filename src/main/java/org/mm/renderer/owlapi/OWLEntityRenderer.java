...
import org.mm.renderer.owlapi.delegator.ObjectPropertyRendererDelegator;
...
public class OWLEntityRenderer implements EntityRenderer, MappingMasterParserConstants {
	...
	private ObjectPropertyRendererDelegator objectPropertyDelegator;
	...
	public OWLEntityRenderer(OWLReferenceRenderer referenceRenderer, OWLObjectFactory objectFactory) {
		...
		objectPropertyDelegator = new ObjectPropertyRendererDelegator(referenceRenderer);
	}
	...
	@Override
	public Optional<OWLObjectPropertyRendering> renderOWLObjectProperty(OWLObjectPropertyNode node) throws RendererException {
		return objectPropertyDelegator.render(node, objectFactory);
	}
