...
<<<<<<< HEAD
  ...
  public Optional<TextRendering> renderOWLRestriction(OWLRestrictionNode owlRestrictionNode) throws RendererException
  {
    ...
    if (owlRestrictionNode.hasOWLMinCardinality())
      ...
      restrictionRendering = renderOWLHasValueRestriction(owlRestrictionNode.getOWLHasValueNode());
  ...
  public Optional<TextRendering> renderOWLMaxCardinality(
    OWLMaxCardinalityRestrictionNode owlMaxCardinalityRestrictionNode) throws RendererException
  {
  ...
  public Optional<TextRendering> renderOWLMinCardinality(
    OWLMinCardinalityRestrictionNode owlMinCardinalityRestrictionNode) throws RendererException
  {
    ...
    throws RendererException
  {
    if (owlAllValuesFromRestrictionNode.hasOWLAllValuesFromDataType())
      return renderOWLDataAllValuesFrom(owlAllValuesFromRestrictionNode.getOWLAllValuesFromDataTypeNode());
    else if (owlAllValuesFromRestrictionNode.hasOWLAllValuesFromClass())
      return renderOWLObjectAllValuesFrom(owlAllValuesFromRestrictionNode.getOWLAllValuesFromClassNode());
    else
      throw new RendererException("unknown OWLAllValuesFrom node " + owlAllValuesFromRestrictionNode);
  }

  public Optional<TextRendering> renderOWLSomeValuesFrom(
    OWLSomeValuesFromRestrictionNode owlSomeValuesFromRestrictionNode) throws RendererException
  {
    if (owlSomeValuesFromRestrictionNode.hasOWLSomeValuesFromDataType())
      return renderOWLDataSomeValuesFrom(owlSomeValuesFromRestrictionNode.getOWLSomeValuesFromDataTypeNode());
    else if (owlSomeValuesFromRestrictionNode.hasOWLSomeValuesFromClass())
      return renderOWLObjectSomeValuesFrom(owlSomeValuesFromRestrictionNode.getOWLSomeValuesFromClassNode());
    else
  ...
  public Optional<TextRendering> renderOWLDataAllValuesFrom(OWLDataAllValuesFromNode owlDataAllValuesFromNode)
    throws RendererException
  {
  ...
  public Optional<TextRendering> renderOWLObjectAllValuesFrom(OWLObjectAllValuesFromNode owlObjectAllValuesFromNode)
    throws RendererException
  {
    ...
    if (owlObjectAllValuesFromNode.hasOWLNamedClass())
      ...
      throw new RendererException("unknown OWLAllValuesFromClass node " + owlObjectAllValuesFromNode);
  ...
  public Optional<TextRendering> renderOWLDataSomeValuesFrom(OWLDataSomeValuesFromNode owlDataSomeValuesFromNode)
    throws RendererException
  {
  ...
  public Optional<TextRendering> renderOWLObjectSomeValuesFrom(OWLObjectSomeValuesFromNode owlObjectSomeValuesFromNode)
    throws RendererException
  {
    Optional<TextRendering> classRendering;
    ...
    if (owlObjectSomeValuesFromNode.hasOWLNamedClass())
      ...
      throw new RendererException("unknown OWLSomeValuesFromClass node " + owlObjectSomeValuesFromNode);
...
=======
	...
	public Optional<TextRendering> renderOWLAllValuesFromDataType(
			OWLDataAllValuesFromNode owlDataAllValuesFromNode) throws RendererException
	{
		String datatypeName = owlDataAllValuesFromNode.getDataTypeName();
	...
	public Optional<TextRendering> renderOWLAllValuesFromClass(OWLObjectAllValuesFromNode owlObjectAllValuesFromNode)
			throws RendererException
	{
		Optional<TextRendering> classRendering;
	...
	public Optional<TextRendering> renderOWLSomeValuesFromDataType(
			OWLDataSomeValuesFromNode owlDataSomeValuesFromNode) throws RendererException
	{
		String datatypeName = owlDataSomeValuesFromNode.getDataTypeName();
	...
	public Optional<TextRendering> renderOWLSomeValuesFromClass(OWLObjectSomeValuesFromNode owlObjectSomeValuesFromNode)
			throws RendererException
	{
		Optional<TextRendering> classRendering;
