...
public class TextRenderer implements Renderer, MappingMasterParserConstants
{
  ...
  public Optional<TextRendering> renderOWLRestriction(OWLRestrictionNode owlRestrictionNode) throws RendererException
  {
    ...
    if (owlRestrictionNode.isOWLMinCardinality())
      ...
      restrictionRendering = renderOWLAllValuesFrom(owlRestrictionNode.getOWLAllValuesFromRestrictionNode());
    else if (owlRestrictionNode.isOWLSomeValuesFrom())
      restrictionRendering = renderOWLSomeValuesFrom(owlRestrictionNode.getOWLSomeValuesFromRestrictionNode());
    else
  ...
  public Optional<TextRendering> renderOWLAllValuesFromDataType(OWLDataAllValuesFromNode owlDataAllValuesFromNode)
    throws RendererException
  {
    String datatypeName = owlDataAllValuesFromNode.getDataTypeName();
  ...
  public Optional<TextRendering> renderOWLSomeValuesFromDataType(OWLDataSomeValuesFromNode owlDataSomeValuesFromNode)
    throws RendererException
  {
    String datatypeName = owlDataSomeValuesFromNode.getDataTypeName();
