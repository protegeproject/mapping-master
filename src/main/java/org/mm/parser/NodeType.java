...
public class NodeType<T extends Node> {
   ...
   public static final NodeType<ASTDataPropertyAssertion> DATA_PROPERTY_ASSERTION = new NodeType<>("DataPropertyAssertion", ASTDataPropertyAssertion.class);
   ...
   public static final NodeType<ASTObjectPropertyAssertion> OBJECT_PROPERTY_ASSERTION = new NodeType<>("ObjectPropertyAssertion", ASTObjectPropertyAssertion.class);
