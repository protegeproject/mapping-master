...
public class MMDefaultDataPropertyValueTypeNode implements RuleDirectiveNode
{
   ...
   {
      return tokenImage[this.defaultDataPropertyValueType].substring(1,
            tokenImage[this.defaultDataPropertyValueType].length() - 1);
   }
