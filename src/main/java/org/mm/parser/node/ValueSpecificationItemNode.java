...
public class ValueSpecificationItemNode implements MMNode
{
   ...
   public String toString()
   {
      ...
      else if (hasCapturingExpression()) representation = "[\"" + this.capturingExpression + "\"]";
   ...
   public boolean equals(Object obj)
   {
      ...
      return this.stringLiteral != null && vs.stringLiteral != null && this.stringLiteral.equals(vs.stringLiteral)
            ...
            && this.valueExtractionFunctionNode.equals(vs.valueExtractionFunctionNode)
            && this.capturingExpression != null && vs.capturingExpression != null
            && this.capturingExpression.equals(vs.capturingExpression);
   }
