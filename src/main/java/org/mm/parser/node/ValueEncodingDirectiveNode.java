...
public class ValueEncodingDirectiveNode implements ReferenceDirectiveNode
{
   ...
   public ValueEncodingDirectiveNode(int defaultValueEncoding)
   {
   ...
   {
      return this.valueEncodingType == MM_LOCATION;
   }

   public boolean hasLocationWithDuplicatesEncoding()
   {
      return this.valueEncodingType == MM_LOCATION_WITH_DUPLICATES;
   }

   public boolean hasLiteralEncoding()
   {
      return this.valueEncodingType == MM_LITERAL;
   }

   public boolean hasRDFIDEncoding()
   {
      return this.valueEncodingType == RDF_ID;
   }

   public boolean hasRDFSLabelEncoding()
   {
      return this.valueEncodingType == RDFS_LABEL;
   }
   ...
   public String toString()
   {
      ...
      if (hasValueSpecificationNode()) representation += this.valueSpecificationNode.toString();
