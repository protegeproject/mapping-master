...
public class OWLObjectSomeValuesFromNode implements MMNode
{
   ...
   public OWLObjectSomeValuesFromNode(ASTOWLObjectSomeValuesFrom node) throws ParseException
   {
      ...
      else throw new InternalParseException(getNodeName() + " node expecting OWLCLass or OWLClassExpression child, got " + child);
   }
   ...
   public String toString()
   {
      ...
      else if (hasOWLClassNode()) representation += this.classNode.toString();
