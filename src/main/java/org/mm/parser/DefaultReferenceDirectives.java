...
public class DefaultReferenceDirectives
{
   ...
   public DefaultReferenceDirectives(int defaultReferenceType, int defaultValueEncoding, int defaultIRIEncoding,
         String defaultLocationValue, String defaultLiteral, String defaultRDFID, String defaultRDFSLabel, String defaultLanguage,
         String defaultPrefix, String defaultNamespace, int defaultShiftDirective, int defaultEmptyLocationDirective,
         int defaultEmptyLiteralDirective, int defaultEmptyRDFIDDirective, int defaultEmptyRDFSLabelDirective,
         int defaultIfExistsDirective, int defaultIfNotExistsDirective)
   {
      ...
      this.defaultIRIEncoding = defaultIRIEncoding;
