...
void rule_directive() throws ParseException {
    ...
    case MM_DEFAULT_VALUE_TYPE:{
      mm_default_value_type_directive();
      break;
      }
    case MM_DEFAULT_PROPERTY_TYPE:{
...
localDirectives = localDirectives.setEntityType(defaultEntityType);
  ...
  final public void mm_default_value_type_directive() throws ParseException {int defaultValueType;
    jj_consume_token(MM_DEFAULT_VALUE_TYPE);
    jj_consume_token(123);
    defaultValueType = value_type();
localDirectives = localDirectives.setValueType(defaultValueType);
}
...
localDirectives = localDirectives.setPropertyType(defaultPropertyType);
  ...
  final public void mm_default_value_datatype_directive() throws ParseException {int defaultValueDatatype;
    ...
    jj_consume_token(123);
    defaultValueDatatype = datatype_type();
...
if (jjtc000) {
  ...
  final public void property_fact() throws ParseException {/*@bgen(jjtree) PropertyFact */
  ASTPropertyFact jjtn000 = new ASTPropertyFact(JJTPROPERTYFACT);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      property();
...
if (jjtc000) {
  ...
  final public void referenced_fact() throws ParseException {/*@bgen(jjtree) ReferencedFact */
  ASTReferencedFact jjtn000 = new ASTReferencedFact(JJTREFERENCEDFACT);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      referenced_property();
...
void restriction() throws ParseException {
  ...
  final public void exact_cardinality() throws ParseException {
    ...
    case FLOAT_LITERAL:
    case NAME:{
      property_exact_cardinality();
      break;
      }
    case 130:{
      referenced_exact_cardinality();
      break;
      }
    default:
      jj_la1[23] = jj_gen;
  ...
  final public void property_exact_cardinality() throws ParseException {/*@bgen(jjtree) PropertyExactCardinality */
  ASTPropertyExactCardinality jjtn000 = new ASTPropertyExactCardinality(JJTPROPERTYEXACTCARDINALITY);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);boolean hasFiller = false;
    try {
      property();
...
if (jjtc000) {
  ...
  final public void referenced_exact_cardinality() throws ParseException {/*@bgen(jjtree) ReferencedExactCardinality */
  ASTReferencedExactCardinality jjtn000 = new ASTReferencedExactCardinality(JJTREFERENCEDEXACTCARDINALITY);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);boolean hasFiller = false;
    try {
      referenced_property();
...
if (jjtc000) {
  ...
  final public void property_max_cardinality() throws ParseException {/*@bgen(jjtree) PropertyMaxCardinality */
  ASTPropertyMaxCardinality jjtn000 = new ASTPropertyMaxCardinality(JJTPROPERTYMAXCARDINALITY);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);boolean hasFiller = false;
    try {
      property();
...
if (jjtc000) {
  ...
  final public void referenced_max_cardinality() throws ParseException {/*@bgen(jjtree) ReferencedMaxCardinality */
  ASTReferencedMaxCardinality jjtn000 = new ASTReferencedMaxCardinality(JJTREFERENCEDMAXCARDINALITY);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);boolean hasFiller = false;
    try {
      referenced_property();
...
if (jjtc000) {
  ...
  final public void property_min_cardinality() throws ParseException {/*@bgen(jjtree) PropertyMinCardinality */
  ASTPropertyMinCardinality jjtn000 = new ASTPropertyMinCardinality(JJTPROPERTYMINCARDINALITY);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);boolean hasFiller = false;
    try {
      property();
...
if (jjtc000) {
  ...
  final public void referenced_min_cardinality() throws ParseException {/*@bgen(jjtree) ReferencedMinCardinality */
  ASTReferencedMinCardinality jjtn000 = new ASTReferencedMinCardinality(JJTREFERENCEDMINCARDINALITY);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);boolean hasFiller = false;
    try {
      referenced_property();
...
if (jjtc000) {
  ...
  final public void property_has_value() throws ParseException {/*@bgen(jjtree) PropertyHasValue */
  ASTPropertyHasValue jjtn000 = new ASTPropertyHasValue(JJTPROPERTYHASVALUE);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      property();
...
if (jjtc000) {
  ...
  final public void referenced_has_value() throws ParseException {/*@bgen(jjtree) ReferencedHasValue */
  ASTReferencedHasValue jjtn000 = new ASTReferencedHasValue(JJTREFERENCEDHASVALUE);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      referenced_property();
...
if (jjtc000) {
  ...
  final public void all_values_from() throws ParseException {
    ...
    case FLOAT_LITERAL:
    case NAME:{
      property_all_values_from();
      break;
      }
    case 130:{
      referenced_all_values_from();
      break;
      }
    default:
      jj_la1[34] = jj_gen;
  ...
  final public void property_all_values_from() throws ParseException {/*@bgen(jjtree) PropertyAllValuesFrom */
  ASTPropertyAllValuesFrom jjtn000 = new ASTPropertyAllValuesFrom(JJTPROPERTYALLVALUESFROM);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      property();
...
if (jjtc000) {
  ...
  final public void referenced_all_values_from() throws ParseException {/*@bgen(jjtree) ReferencedAllValuesFrom */
  ASTReferencedAllValuesFrom jjtn000 = new ASTReferencedAllValuesFrom(JJTREFERENCEDALLVALUESFROM);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      referenced_property();
...
if (jjtc000) {
  ...
  final public void some_values_from() throws ParseException {
    ...
    case FLOAT_LITERAL:
    case NAME:{
      property_some_values_from();
      break;
      }
    case 130:{
      referenced_some_values_from();
      break;
      }
    default:
      jj_la1[35] = jj_gen;
  ...
  final public void property_some_values_from() throws ParseException {/*@bgen(jjtree) PropertySomeValuesFrom */
  ASTPropertySomeValuesFrom jjtn000 = new ASTPropertySomeValuesFrom(JJTPROPERTYSOMEVALUESFROM);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      property();
...
if (jjtc000) {
  ...
  final public void referenced_some_values_from() throws ParseException {/*@bgen(jjtree) ReferencedSomeValuesFrom */
  ASTReferencedSomeValuesFrom jjtn000 = new ASTReferencedSomeValuesFrom(JJTREFERENCEDSOMEVALUESFROM);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      referenced_property();
...
if (jjtc000) {
  ...
  final public void filler() throws ParseException {/*@bgen(jjtree) Filler */
  ASTFiller jjtn000 = new ASTFiller(JJTFILLER);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);int datatype = -1;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case XSD_STRING:
      case XSD_DECIMAL:
...
if (jjtc000) {
  ...
  final public void class_expression_filler() throws ParseException {/*@bgen(jjtree) ClassExpressionFiller */
  ASTClassExpressionFiller jjtn000 = new ASTClassExpressionFiller(JJTCLASSEXPRESSIONFILLER);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
//------------------------------------------------------------------------------------------
  final public 
void referenced_property() throws ParseException {/*@bgen(jjtree) ReferencedProperty */
  ASTReferencedProperty jjtn000 = new ASTReferencedProperty(JJTREFERENCEDPROPERTY);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
...
//------------------------------------------------------------------------------------------
  final public 
void any_value() throws ParseException {/*@bgen(jjtree) AnyValue */
  ASTAnyValue jjtn000 = new ASTAnyValue(JJTANYVALUE);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
if (jjtc000) {
  ...
  final public void value(int type) throws ParseException {/*@bgen(jjtree) Value */
...
userDirectives = userDirectives.setEntityType(value);
    ...
    case TERM:{
      value = value_type();
userDirectives = userDirectives.setValueType(value);
      break;
      }
    case XSD_STRING:
    case XSD_DECIMAL:
...
//------------------------------------------------------------------------------------------
  final public 
void datatype() throws ParseException {/*@bgen(jjtree) Datatype */
...
//------------------------------------------------------------------------------------------
  final public 
int datatype_type() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case XSD_STRING:{
...
{if ("" != null) return t.kind;}
  ...
  final public int iri_encoding() throws ParseException {Token t;
  int encodingType;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case MM_NO_ENCODE:{
...
entityType = t.kind;
    ...
    case OWL_DATATYPE:{
      t = jj_consume_token(OWL_DATATYPE);
entityType = t.kind;
      break;
      }
    case OWL_LITERAL:{
...
{if ("" != null) return entityType;}
  ...
  final public int value_type() throws ParseException {Token t;
  int valueType;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case TERM:{
...
{if ("" != null) return orderType;}
 ...
 {
    if (jj_scan_token(OWL_DATATYPE)) return true;
    return false;
  }
  ...
  private boolean jj_3R_49()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x6000,0x0,0x6000,0x98000,0x98000,0x0,0x0,0x0,0x80000000,0x3e0000,0x3e0000,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x80000000,0x80000000,0xc0000000,0x20000000,0x10000000,0x0,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x0,0x80000000,0x80000000,0x80000000,0x80000000,0x0,0x80000000,0x80000000,0x80000000,0x80000000,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x80000000,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x3f40000,0x3f40000,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x1,0x1,0x0,0x0,0x1,0x1,0x1,0x0,0x0,0x0,0x1,0xbfff,0xbfff,0x1,0xbfff,0xbfff,0x1,0xbfff,0xbfff,0x0,0x1,0x1,0x1,0xbfff,0x0,0x1,0x1,0x1,0x1,0xc02bffe,0x0,0x1,0xc02bffe,0xc0000000,0x0,0x0,0x0,0x1,0x0,0x0,0x1,0x1,0x1,0xbffe,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_2() {
	   jj_la1_2 = new int[] {0x7c000000,0x7c000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x83e001ff,0x1ffe00,0x0,0x83e001ff,0x0,0x0,0x1ffe00,0x0,0x0,0x1ffe00,0x0,0x0,0x0,0x0,0x0,0x3e00000,0x7f,0x180,0x1c,0x80000000,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_3() {
	   jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x10000000,0x10000000,0x10000000,0x170000,0x0,0x0,0x10000000,0x10000000,0x4170000,0x170000,0x10000000,0x10000000,0xa4170000,0x4170000,0xa4170000,0x0,0x0,0x10000000,0x4170000,0xa4170000,0xa4170000,0x4170000,0xa4170000,0xa4170000,0x4170000,0xa4170000,0xa4170000,0x40000,0x4170000,0x4170000,0x4170000,0xa4170000,0xa0000000,0x4170000,0x4170000,0x4170000,0x4170000,0xfff,0x0,0x160000,0xfff,0x20000,0x8000000,0x0,0x20000000,0x160000,0x0,0x10000000,0x160000,0x0,0x4170000,0x0,0x0,0x0,0x0,0x0,0xf,0xf0,0xf00,0xf000,};
	}
	private static void jj_la1_init_4() {
	   jj_la1_4 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x0,0x0,0x0,0x0,0x4,0x4,0x0,0x0,0x4,0x4,0x4,0x0,0x0,0x0,0x4,0x4,0x4,0x4,0x4,0x4,0x4,0x4,0x4,0x4,0x4,0x4,0x4,0x4,0x0,0x4,0x4,0x4,0x0,0x0,0x10,0x0,0x0,0x0,0x8,0x0,0x0,0x4,0x10,0x0,0x4,0x0,0x4,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
