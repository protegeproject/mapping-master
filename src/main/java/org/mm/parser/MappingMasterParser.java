...
public class MappingMasterParser/*@bgen(jjtree)*/implements MappingMasterParserTreeConstants, MappingMasterParserConstants {/*@bgen(jjtree)*/
  ...
  private int propertyValueDatatype;
  ...
  public MappingMasterParser(java.io.InputStream inputStream, ReferenceDirectives systemDirectives, int unused) {
    ...
    propertyValueType = systemDirectives.getPropertyValueType();
    propertyValueDatatype = systemDirectives.getPropertyValueDatatype();
...
SimpleNode transformation_rule() throws ParseException {/*@bgen(jjtree) TransformationRule */
  ...
  jjtree.openNodeScope(jjtn000);
    try {
      ...
      case MM_DEFAULT_PROPERTY_VALUE_DATATYPE:
...
void rule_directive() throws ParseException {
    ...
    case MM_DEFAULT_PROPERTY_VALUE_DATATYPE:{
      mm_default_property_value_datatype_directive();
      break;
      }
    case MM_DEFAULT_VALUE_ENCODING:{
...
language = defaultLanguage;
  ...
  final public void mm_default_reference_type_directive() throws ParseException {int defaultReferenceType;
...
propertyType = defaultPropertyType;
  ...
  final public void mm_default_property_value_type_directive() throws ParseException {int defaultPropertyValueType;
    jj_consume_token(MM_DEFAULT_PROPERTY_VALUE_TYPE);
    jj_consume_token(126);
    defaultPropertyValueType = property_value_type();
propertyValueType = defaultPropertyValueType;
  }

  final public void mm_default_property_value_datatype_directive() throws ParseException {int defaultPropertyValueDatatype;
    jj_consume_token(MM_DEFAULT_PROPERTY_VALUE_DATATYPE);
    jj_consume_token(126);
    defaultPropertyValueDatatype = datatype();
propertyValueDatatype = defaultPropertyValueDatatype;
  }

  final public void mm_default_value_encoding_directive() throws ParseException {int defaultValueEncoding;
    jj_consume_token(MM_DEFAULT_VALUE_ENCODING);
    jj_consume_token(126);
    defaultValueEncoding = value_encoding();
...
if (jjtc000) {
  ...
  jjtree.openNodeScope(jjtn000);
    try {
      ...
      if (jj_2_1(2)) {
        data_property_assertion_list();
      } else if (jj_2_2(2)) {
        object_property_assertion_list();
      } else {
        jj_consume_token(-1);
        throw new ParseException();
      }
...
if (jjtc000) {
  ...
  final public void data_property_assertion_list() throws ParseException {
  ...
  final public void object_property_assertion_list() throws ParseException {
  ...
  final public void data_property_assertion() throws ParseException {/*@bgen(jjtree) DataPropertyAssertion */
  ASTDataPropertyAssertion jjtn000 = new ASTDataPropertyAssertion(JJTDATAPROPERTYASSERTION);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      data_property();
...
if (jjtc000) {
  ...
  final public void object_property_assertion() throws ParseException {/*@bgen(jjtree) ObjectPropertyAssertion */
  ASTObjectPropertyAssertion jjtn000 = new ASTObjectPropertyAssertion(JJTOBJECTPROPERTYASSERTION);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      object_property();
...
//------------------------------------------------------------------------------------------
  final public 
void value(int referenceType) throws ParseException {/*@bgen(jjtree) ValueCategory */
  ASTValueCategory jjtn000 = new ASTValueCategory(JJTVALUECATEGORY);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
if (jjtc000) {
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);int localReferenceType = type;
  ReferenceDirectives referenceDirectives;
    try {
      ...
      if (jj_2_15(2)) {
        ...
        case OWL_IRI:
        case MM_ENTITY_IRI:{
          localReferenceType = reference_type();
          break;
          }
        default:
          jj_la1[33] = jj_gen;
...
jjtree.closeNodeScope(jjtn000, true);
    jjtc000 = false;
referenceType = localReferenceType;
    jjtn000.referenceDirectives = new ReferenceDirectives(
        prefix, namespace, language, labelValue, literalValue,
        referenceType, propertyType, propertyValueType, propertyValueDatatype,
...
void reference_notation() throws ParseException {/*@bgen(jjtree) ReferenceNotation */
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);String sheetName = null;
  String cellNotation;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case QUOTED_NAME:{
        sheetName = quoted_name();
      ...
      cellNotation = cell_notation();
jjtree.closeNodeScope(jjtn000, true);
    jjtc000 = false;
jjtn000.referenceNotation = new ReferenceNotation(Optional.ofNullable(sheetName), cellNotation);
    } catch (Throwable jjte000) {
if (jjtc000) {
      jjtree.clearNodeScope(jjtn000);
      jjtc000 = false;
...
String s = t.image;
  ...
  final public String cell_notation() throws ParseException {Token t;
    t = jj_consume_token(CELL_NOTATION);
...
//------------------------------------------------------------------------------------------
  final public 
void reference_directive() throws ParseException {int localValueEncoding;
  int localIriEncoding;
  int localShiftDirection;
  int localOrderIfCellEmpty;
  int localOrderIfEntityAbsent;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case MM_PREFIX:{
      prefix_directive();
      break;
    ...
    case RDFS_LABEL:
    case OWL_LITERAL:{
      localValueEncoding = value_encoding();
valueEncoding = localValueEncoding;
      break;
      }
    case MM_NO_ENCODE:
    case MM_CAMELCASE_ENCODE:
    ...
    case MM_UUID_ENCODE:
    case MM_HASH_ENCODE:{
      localIriEncoding = iri_encoding();
iriEncoding = localIriEncoding;
      break;
      }
    case MM_NO_SHIFT:
    case MM_SHIFT_UP:
    ...
    case MM_SHIFT_LEFT:
    case MM_SHIFT_RIGHT:{
      localShiftDirection = shift_direction();
shiftDirection = localShiftDirection;
      break;
      }
    case MM_CREATE_IF_CELL_EMPTY:
    case MM_IGNORE_IF_CELL_EMPTY:
    case MM_WARNING_IF_CELL_EMPTY:
    case MM_ERROR_IF_CELL_EMPTY:{
      localOrderIfCellEmpty = order_if_cell_empty();
orderIfCellEmpty = localOrderIfCellEmpty;
      break;
      }
    case MM_CREATE_IF_ENTITY_ABSENT:
    case MM_IGNORE_IF_ENTITY_ABSENT:
    case MM_WARNING_IF_ENTITY_ABSENT:
    case MM_ERROR_IF_ENTITY_ABSENT:{
      localOrderIfEntityAbsent = order_if_entity_absent();
orderIfEntityAbsent = localOrderIfEntityAbsent;
      break;
      }
    default:
      jj_la1[37] = jj_gen;
...
//------------------------------------------------------------------------------------------
  final public 
int value_encoding() throws ParseException {Token t;
  int encodingType;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case RDF_ID:{
      t = jj_consume_token(RDF_ID);
encodingType = t.kind;
      break;
      }
    case RDFS_LABEL:{
      t = jj_consume_token(RDFS_LABEL);
encodingType = t.kind;
      break;
      }
    case OWL_LITERAL:{
...
referenceType = datatype;
       propertyValueDatatype = datatype; // assign as well as property value datatype
...
{if ("" != null) return propertyType;}
  ...
  final public int property_value_type() throws ParseException {Token t;
  int propertyValueType;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case OWL_IRI:{
      t = jj_consume_token(OWL_IRI);
propertyValueType = t.kind;
      break;
      }
    case MM_ENTITY_IRI:{
      t = jj_consume_token(MM_ENTITY_IRI);
...
{if ("" != null) return propertyValueType;}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return orderType;}
 ...
 {
    if (jj_scan_token(CELL_NOTATION)) return true;
    return false;
  }

  private boolean jj_3R_139()
 {
    if (jj_scan_token(QUOTED_NAME)) return true;
    return false;
  }
  ...
  private boolean jj_3R_54()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x6000,0x0,0x6000,0x98000,0x98000,0x0,0x0,0x0,0x3e0000,0x3e0000,0x0,0x0,0x0,0x0,0x0,0x80000000,0xc0000000,0x20000000,0x10000000,0x0,0x80000000,0x80000000,0x0,0x80000000,0x0,0x80000000,0x0,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0xfd80000,0xfd80000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x1,0x0,0x0,0x0,0x1,0x1,0x0,0x1,0x0,0x1,0x0,0x1,0x1,0x1,0x1,0x1,0x0,0xbffe,0x30070000,0x1,0x0,0x30070000,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x1,0x1,0xbffe,0x30000,0x0,0xbffe,0x0,0xbffe,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0xe0000000,0xe0000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xcf8,0x1ffff100,0x0,0x0,0x1ffff100,0x6,0x0,0xfff000,0x0,0x0,0xfff000,0x0,0x0,0x0,0x0,0x100,0x1f000000,0xcf8,0xe0,0xc00,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x3,0x3,0x0,0x0,0x0,0x80000000,0x80000000,0x80000000,0x0,0x0,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x20b80000,0x20b80000,0x0,0x0,0x80000000,0x20b80000,0x20b80000,0x0,0x20b80000,0x0,0x20b80000,0x0,0x20b80000,0x20b80000,0x20b80000,0x20b80000,0xb00000,0x20000000,0x0,0x7ffc,0xb00000,0x1000000,0x7ffc,0x100000,0x40000000,0x0,0x0,0xb00000,0x0,0x80000000,0xb00000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x7c,0x780,0x7800,0x78000,};
   }
   private static void jj_la1_init_4() {
      jj_la1_4 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x15,0x15,0x0,0x0,0x0,0x10,0x10,0x1,0x10,0x1,0x10,0x1,0x10,0x10,0x10,0x10,0x10,0x10,0x0,0x40,0x0,0x0,0x40,0x0,0x20,0x0,0x1,0x10,0x40,0x0,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
