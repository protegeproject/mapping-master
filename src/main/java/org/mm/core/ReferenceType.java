...
public class ReferenceType implements MappingMasterParserConstants {
   ...
   public boolean isTypedLiteral() {
      return isXSDString() || isXSDBoolean() || isXSDDouble() || isXSDFloat() || isXSDLong()
            || isXSDInteger() || isXSDShort() || isXSDByte() || isXSDDecimal() || isXSDDateTime()
            || isXSDDate() || isXSDTime() || isXSDDuration();
   }
   ...
   public boolean isQuotedOWLLiteral() {
      return isXSDString() || isXSDDateTime() || isXSDDate() || isXSDTime() || isXSDDuration()
            || isRDFPlainLiteral();
   }
